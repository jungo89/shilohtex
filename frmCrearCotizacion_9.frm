VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmCrearCotizacion_9 
   Caption         =   "Crear Cotización"
   ClientHeight    =   13920
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   28155
   OleObjectBlob   =   "frmCrearCotizacion_9.frx":0000
   StartUpPosition =   2  'Centrar en pantalla
End
Attribute VB_Name = "frmCrearCotizacion_9"
...
'Dim sTotal As Currency
       ...
       'MsgBox (Me.txtSubtotal.Text)
        ...
        With frmCotizacion
            .lstDetalleFact1.AddItem (txtUnidadesSolicitadas * Me.txtCantidadSolicitada.Text) 'cantidad solicitada unidades por producto
            .lstDetalleFact1.List(i, 1) = (Me.txtUnidades * Me.txtCantidad.Text) 'cantidad entregada unidades por producto
            .lstDetalleFact1.List(i, 2) = (txtUnidadesSolicitadas * Me.txtCantidadSolicitada.Text) - (Me.txtUnidades * Me.txtCantidad.Text) 'cantidad pendiente por entregar
...
Private Sub txtCantidadSolicitada_Exit(ByVal Cancel As MSForms.ReturnBoolean)
On Error Resume Next
    Me.txtCantidadSolicitada.Value = FormatNumber(Me.txtCantidadSolicitada.Value, 0)
End Sub

Private Sub txtCantidadSolicitada_KeyPress(ByVal KeyAscii As MSForms.ReturnInteger)
    If Application.DecimalSeparator = "." Then
        If KeyAscii <> 46 And KeyAscii < 48 Or KeyAscii > 57 Then
            KeyAscii = 0
        End If
...
Private Sub txtUnidadesSolicitadas_Change()
    Me.txtUnidadesSolicitadas.BackColor = &HFFFFFF

    On Error Resume Next
    Me.txtUnidadesSolicitadas.Value = FormatNumber(Me.txtUnidadesSolicitadas.Value, 0)
End Sub

Private Sub txtUnidadesSolicitadas_KeyPress(ByVal KeyAscii As MSForms.ReturnInteger)
    If Application.DecimalSeparator = "." Then
        If KeyAscii <> 46 And KeyAscii < 48 Or KeyAscii > 57 Then
            KeyAscii = 0
        End If
...
Private Sub txtUnidades_Change()
    ...
    On Error Resume Next
    Me.txtUnidades.Value = FormatNumber(Me.txtUnidades.Value, 0)
    ...
    If Me.txtUnidades > Me.txtUnidadesSolicitadas Then MsgBox ("La cantidad entregada no puede ser mayor a la solicitada"): Exit Sub
    
    'me.txtValorUnitarioIva = me.txtValorUnitario *
    ...
    Else
        'MsgBox ("Digite unidades entregadas"): Exit Sub
        Me.txtSubtotal = Empty
    End If
